...
> *Diagrams use the hand-drawn [Excalidraw](https://excalidraw.com) style. Source files in [`docs/architecture/`](docs/architecture/) — editable with the [VS Code Excalidraw extension](https://marketplace.visualstudio.com/items?itemName=pomdtr.excalidraw-editor).*

### System Overview

How the extension connects to external services, the local filesystem, and the terminal.

![System Context](docs/architecture/01-system-context.svg)
...
![Install Flow](docs/architecture/02-install-flow.svg)
...
![Multi-Agent Scanning](docs/architecture/03-multi-agent-scanning.svg)
...
![Webview Communication](docs/architecture/04-webview-communication.svg)
...
![CI/CD Pipeline](docs/architecture/05-ci-cd-pipeline.svg)
